...
try {
    ...
    $tablesToFix = [
        ...
        'user_tv_shows' => [
            ...
            ['name' => 'episode_runtime', 'sql' => "ALTER TABLE user_tv_shows ADD COLUMN episode_runtime INT NULL AFTER number_of_episodes"],
            ['name' => 'networks', 'sql' => "ALTER TABLE user_tv_shows ADD COLUMN networks JSON NULL AFTER episode_runtime"],
        ],
        'user_documentaries' => [
        ...
        'user_games' => [
            ['name' => 'cover_image_cdn', 'sql' => "ALTER TABLE user_games ADD COLUMN cover_image_cdn TEXT NULL AFTER name"],
            ['name' => 'cover_image_local', 'sql' => "ALTER TABLE user_games ADD COLUMN cover_image_local TEXT NULL AFTER cover_image_cdn"],
            ['name' => 'overview', 'sql' => "ALTER TABLE user_games ADD COLUMN overview TEXT NULL AFTER cover_image_local"],
            ['name' => 'genres', 'sql' => "ALTER TABLE user_games ADD COLUMN genres JSON NULL AFTER overview"],
            ['name' => 'external_rating', 'sql' => "ALTER TABLE user_games ADD COLUMN external_rating DECIMAL(3,1) NULL AFTER genres"],
            ['name' => 'backdrop_image_cdn', 'sql' => "ALTER TABLE user_games ADD COLUMN backdrop_image_cdn TEXT NULL AFTER external_rating"],
            ['name' => 'backdrop_image_local', 'sql' => "ALTER TABLE user_games ADD COLUMN backdrop_image_local TEXT NULL AFTER backdrop_image_cdn"],
            ['name' => 'platforms', 'sql' => "ALTER TABLE user_games ADD COLUMN platforms JSON NULL AFTER backdrop_image_local"],
            ['name' => 'developers', 'sql' => "ALTER TABLE user_games ADD COLUMN developers JSON NULL AFTER platforms"],
            ['name' => 'publishers', 'sql' => "ALTER TABLE user_games ADD COLUMN publishers JSON NULL AFTER developers"],
            ['name' => 'game_modes', 'sql' => "ALTER TABLE user_games ADD COLUMN game_modes JSON NULL AFTER publishers"],
        ],
        'user_podcasts' => [
